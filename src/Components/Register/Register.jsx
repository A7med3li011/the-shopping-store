...
export default function Register() {
  ...
  return (
    <>
      ...
      <div className="container  w-50 cont pt-5 m-auto">
        <h1>Register Now:</h1>
        ...
        <form onSubmit={formikRegister.handleSubmit} >
          ...
          <button onClick={() => setIsLoading(true)} type='sumbit' disabled={!(formikRegister.dirty && formikRegister.isValid)} className='btn bb bg-main text-white d-block ms-auto'>{isLoading ? <i className='fa fa-spinner fa-spin'></i> : "Register"}</button>
